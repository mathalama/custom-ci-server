package dev.mathalama.rabotyagaci.agent;
...
public class AgentApplication {
    ...
    public static void main(String[] args) {
        log.info("Starting RabotyagaCI Agent...");
        ...
        workspacesDir = Paths.get(System.getProperty("user.home"), ".rabotyagaci-agent", "workspaces");
        try {
    ...
    private static class AgentClient extends WebSocketClient {
        ...
        public void onOpen(ServerHandshake handshakedata) {
            log.info("Connected to RabotyagaCI Master! Handshake status: {}", handshakedata.getHttpStatus());
